...
using WorkPulse.Api.Tests.Infrastructure;

namespace WorkPulse.Api.Tests.Auth;
...
public class AuthEndpointsTests
{
    ...
    public async Task Register_ShouldCreateDeveloperUser()
    {
        ...
        var role = json.GetProperty("user").GetProperty("role").GetString();
    ...
    public async Task Login_ShouldReturnTokenForValidCredentials()
    {
        ...
        var payload = new
        {
            email = "developer@workpulse.local",
            password = "WorkPulseDev123!"
        };
